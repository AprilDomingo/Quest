...
public class AddTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstItinerary.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent launchIntent = new Intent(AddTask.this, MapsActivity.class);
                        TaskDetails locationStr = mItineraryList.get(position);
                        String targetLocation = locationStr.getLocation();
                        launchIntent.putExtra("LOCATION", targetLocation);
